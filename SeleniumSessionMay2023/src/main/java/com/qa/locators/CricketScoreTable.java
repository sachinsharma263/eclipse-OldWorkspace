...
public class CricketScoreTable {
	...
	public static List<WebElement> getScoreList(WebDriver driver,String playerName) {
		...
		List<WebElement> list=driver.findElements(By.xpath("//span[text()='"+playerName+"']//ancestor::td//following-sibling::td[@class='ds-w-0 ds-whitespace-nowrap ds-min-w-max ds-text-right']"));
	...
	public static void getWicketTaker(WebDriver driver,String playerName) {
		String text=driver.findElement(By.xpath("//span[text()='George Munsey']//ancestor::td//following-sibling::td[@class='ds-min-w-max !ds-pl-[100px]']")).getText();
