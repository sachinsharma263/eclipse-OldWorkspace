...
public class JavaScriptExecutorTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		//jsutil.clickElementByJS(GenericMethods.getElement(driver, By.xpath("/html/body/section[1]/div[2]/div/div[1]/div/a[2]")));
		
		//jsutil.drawBorder(GenericMethods.getElement(driver,By.xpath("/html/body/section[1]/div[2]/div/div[1]/div/a[2]")));
