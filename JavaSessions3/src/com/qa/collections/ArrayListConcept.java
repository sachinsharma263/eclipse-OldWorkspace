 ...
 * Insersion order is prerved.The order in which we inserted the value s,in the same order the value will be stored.
 * ArrayList- ordered based maintains sequence
 * duplicate values are allowed
 * array list size will be based on how many values i have stored,what will i do with virtual capacity,its internal implemtation
