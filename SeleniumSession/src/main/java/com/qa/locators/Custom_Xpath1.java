...
public class Custom_Xpath1 {
	...
	public static void main(String[] args) {
		...
		//absolute xpath start from begining and traverse all the tags till reach that web element
		//todays are xpath is working but tomorrow there is no guarantee whether it will work or not.suppose one of the dive changes our xpath changed
		// thats why we have to use relative xpath or custom xpath where we directly go to that element
		...
		//above element having id so we can use By.id but i dnt waant to use id locator, i want to use xpath
		...
		// By.className("//input[@class='form-control private-form__control login-email']") -- this will not work because cascaded classes are not allowed with By.className
